      ...
      <div className="container-responsive py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="footer-section">
            <h3 className="text-subheading mb-6 text-white">Enlaces Rápidos</h3>
            <ul className="space-y-3">
              <li>
                <Link to="/" className="footer-link text-gray-300 hover:text-white">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/productos" className="footer-link text-gray-300 hover:text-white">
                  Productos
                </Link>
              </li>
              <li>
                <Link to="/quienes-somos" className="footer-link text-gray-300 hover:text-white">
                  Quienes Somos
                </Link>
              </li>
              <li>
                <Link to="/contacto" className="footer-link text-gray-300 hover:text-white">
                  Contacto
                </Link>
              </li>
            </ul>
          ...
          {/* Contact Info */}
          <div className="footer-section">
            <h3 className="text-subheading mb-6 text-white">Contacto</h3>
